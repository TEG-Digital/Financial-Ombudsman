        ...
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="mt-0 mb-16 reveal-from-bottom" data-reveal-delay="200">
              <span className="text-color-primary">Financial dispute resolution that’s fair and impartial</span>
              <Image
                      data-reveal-delay="200"
                      src={require('./../../assets/images/service.gif')}
          ...
          <div className="hero-figure reveal-from-bottom illustration-element-01" data-reveal-value="20px" data-reveal-delay="400">
            <a
              data-video="https://www.youtube.com/embed/HLfvo6xj6dY"
              href="#0"
            ...
            >
              <Image
                ...
                src={require('./../../assets/images/ombud_video_layover.png')}
                alt="Hero"
                width={896}
                height={504} />
            </a>
          ...
          <Modal
            ...
            video="https://www.youtube.com/embed/HLfvo6xj6dY"
            videoTag="iframe" />
        </div>
      </div>
    </section>
